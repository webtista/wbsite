...
>
   <div class="text-center px-4 bg-black/50 py-6 rounded">
     <h1 class="text-4xl md:text-6xl font-bold mb-4">Luxury Wheels for Supercars</h1>
 ...
 <section class="py-16 bg-customLight dark:bg-customDark">
   <div class="container mx-auto text-center">
     <h2 class="text-3xl font-bold mb-8">Brands We Carry</h2>
 ...
 <section class="py-16 bg-customLight dark:bg-customDark">
   <div class="container mx-auto text-center">
     <h2 class="text-3xl font-bold mb-8">Customer Vehicle Gallery</h2>
 ...
 <section class="py-16">
   <div class="container mx-auto text-center">
     <h2 class="text-3xl font-bold mb-8">Why Choose Wheels Boutique?</h2>
